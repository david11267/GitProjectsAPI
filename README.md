...
2. Set your options
3. Make a request: at : curl 'https://spring-backend-a4qk4.ondigitalocean.app/api/projects?apiKey=YOUR_API_KEY'
or
const response = await fetch(`https://spring-backend-a4qk4.ondigitalocean.app/api/projects?apiKey=${apiKey}`)
5. parse result as json and integrate to your project.
